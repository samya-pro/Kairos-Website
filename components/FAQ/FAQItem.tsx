    ...
    <>
      <div className="flex flex-col border-b border-stroke last-of-type:border-none dark:border-strokedark">
        <button
          ...
          className="flex cursor-pointer items-center justify-between px-6 py-5 text-metatitle3 text-left mr-2 font-medium text-black dark:text-white lg:px-9 lg:py-7.5"
        >
          {quest}
